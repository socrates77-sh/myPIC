...
; This file was generated Fri Aug 18 19:27:38 2017
;--------------------------------------------------------
...
;	.line	44; adc/adcsetch.c	ADCON0 = (ADCON0 & ~(0x0f << 2)) | ((channel & 0x0f) << 2);
	MOVF	_ADCON0, W
	MOVWF	r0x01
; ;ic:5: 	iTemp2 [k6 lr5:9 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{char register}[r0x01 ] = iTemp1 [k5 lr4:5 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{char register}[r0x01 ] & 0xffffffc3 {char literal}
	MOVLW	0xc3
	ANDWF	r0x01, F
; ;ic:6: 	iTemp3 [k7 lr6:7 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x00 ] = iTemp0 [k2 lr3:6 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{unsigned-char fixed}{ sir@ _adc_setchannel_channel_1_7}[r0x00 ] & 0xf {const-unsigned-char literal}
	MOVLW	0x0f
	ANDWF	r0x00, F
