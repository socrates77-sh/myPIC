...
; This file was generated Fri Aug 18 19:27:35 2017
;--------------------------------------------------------
...
;	.line	48; adc/adcopen.c	ADCON0 = 0;
	CLRF	_ADCON0
; ;ic:8: 	iTemp4 [k11 lr8:9 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x00 ] = iTemp0 [k2 lr3:8 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{unsigned-char fixed}{ sir@ _adc_open_channel_1_7}[r0x00 ] & 0xf {const-unsigned-char literal}
;	.line	82; adc/adcopen.c	ADCON0 = (channel & 0x0f) << 2;
	MOVLW	0x0f
	ANDWF	r0x00, F
; ;ic:9: 	_ADCON0 [k10 lr0:0 so:0]{ ia1 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-unsigned-char sfr} = iTemp4 [k11 lr8:9 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x00 ] << 0x2 {const-unsigned-char literal}
	...
	ANDLW	0xfc
	MOVWF	_ADCON0
; ;ic:10: 	iTemp6 [k14 lr10:12 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x02 ] = iTemp2 [k6 lr5:10 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{unsigned-char fixed}{ sir@ _adc_open_pcfg_1_7}[r0x02 ] & 0x3f {const-unsigned-char literal}
;	.line	85; adc/adcopen.c	ADCON1 = (pcfg & 0x3f) | (config & ADC_VCFG_AN3_AN2);
	MOVLW	0x3f
	ANDWF	r0x02, F
; ;ic:11: 	iTemp7 [k15 lr11:12 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x00 ] = iTemp3 [k8 lr6:16 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{unsigned-char fixed}{ sir@ _adc_open_config_1_7}[r0x03 ] & 0x30 {const-unsigned-char literal}
	MOVLW	0x30
	ANDWF	r0x03, W
; #	MOVWF	r0x00
...
; #	MOVF	r0x00, W
	IORWF	r0x02, W
	MOVWF	_ADCON1
; ;ic:13: 	iTemp9 [k18 lr13:15 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x00 ] = iTemp3 [k8 lr6:16 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{unsigned-char fixed}{ sir@ _adc_open_config_1_7}[r0x03 ] & 0x80 {const-unsigned-char literal}
;	.line	86; adc/adcopen.c	ADCON2 = (config & ADC_FRM_RJUST) | (fosc & 0x3f);
	MOVLW	0x80
	ANDWF	r0x03, W
	MOVWF	r0x00
; ;ic:14: 	iTemp10 [k19 lr14:15 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x01 ] = iTemp1 [k4 lr4:14 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{unsigned-char fixed}{ sir@ _adc_open_fosc_1_7}[r0x01 ] & 0x3f {const-unsigned-char literal}
	MOVLW	0x3f
	ANDWF	r0x01, F
; ;ic:15: 	_ADCON2 [k17 lr0:0 so:0]{ ia1 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-unsigned-char sfr} = iTemp9 [k18 lr13:15 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x00 ] | iTemp10 [k19 lr14:15 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char register}[r0x01 ]
	MOVF	r0x01, W
	IORWF	r0x00, W
	MOVWF	_ADCON2
...
; ;ic:18: 	iTemp13 [k23 lr18:19 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {6,1} near* fixed}[remat] = &[_PIR1bits [k22 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000051 fixed}]
...
;	.line	104; adc/adcopen.c	PIR1bits.ADIF = 0;
	BCF	_PIR1bits, 6
; ;ic:21: 	iTemp15 [k27 lr21:22 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {6,1} near* fixed}[remat] = &[_PIE1bits [k26 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000049 fixed}]
...
;	.line	105; adc/adcopen.c	PIE1bits.ADIE = 1;
	BSF	_PIE1bits, 6
; ;ic:24: 	iTemp17 [k31 lr24:25 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {6,1} near* fixed}[remat] = &[_INTCONbits [k30 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000182 fixed}]
...
;	.line	106; adc/adcopen.c	INTCONbits.PEIE = 1;
	BSF	_INTCONbits, 6
; ;ic:27:  _iffalse_0($2) :
; ;ic:28: 	iTemp19 [k35 lr28:29 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {0,1} near* fixed}[remat] = &[_ADCON0bits [k34 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000110 fixed}]
