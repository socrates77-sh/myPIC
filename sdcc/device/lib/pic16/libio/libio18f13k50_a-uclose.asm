...
; This file was generated Fri Aug 18 19:26:45 2017
;--------------------------------------------------------
...
;	.line	40; usart/uclose.c	RCSTA &= 0x4f;
	MOVLW	0x4f
	ANDWF	_RCSTA, F
; ;ic:4: 	iTemp1 [k5 lr4:5 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {5,1} near* fixed}[remat] = &[_TXSTAbits [k4 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000291 fixed}]
