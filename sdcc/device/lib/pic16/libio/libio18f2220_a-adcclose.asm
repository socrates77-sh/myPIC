...
; This file was generated Fri Aug 18 19:27:33 2017
;--------------------------------------------------------
...
_adc_close:
; ;ic:3: 	iTemp0 [k3 lr3:4 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {0,1} near* fixed}[remat] = &[_ADCON0bits [k2 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000110 fixed}]
...
;	.line	38; adc/adcclose.c	ADCON0bits.ADON = 0;
	BCF	_ADCON0bits, 0
; ;ic:6: 	iTemp2 [k7 lr6:7 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {6,1} near* fixed}[remat] = &[_PIE1bits [k6 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000049 fixed}]
