...
; This file was generated Fri Aug 18 19:26:31 2017
;--------------------------------------------------------
...
;	.line	34; i2c/i2cidle.c	while((SSPCON2 & 0x1f) | (SSPSTATbits.R_W));
	...
	ANDWF	_SSPCON2, W
	MOVWF	r0x00
; ;ic:6: 	iTemp1 [k5 lr6:7 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {2,1} near* fixed}[remat] = &[_SSPSTATbits [k4 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00000404 fixed}]
